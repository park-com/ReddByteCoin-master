#############################################################################
# Makefile for building: ReddByte-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: ?? ??? 24 11:53:39 2016
# Project:  ReddByte-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile ReddByte-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/maxim/ReddByteCoin-master/src/leveldb/libleveldb.a /home/maxim/ReddByteCoin-master/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/maxim/ReddByteCoin-master/src/leveldb/libleveldb.a /home/maxim/ReddByteCoin-master/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ReddByte-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile ReddByte-qt.pro
...
/home/maxim/ReddByteCoin-master/src/leveldb/libleveldb.a: FORCE
	cd /home/maxim/ReddByteCoin-master/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/maxim/ReddByteCoin-master/build/build.h: FORCE
	cd /home/maxim/ReddByteCoin-master; /bin/sh share/genbuild.sh /home/maxim/ReddByteCoin-master/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/ReddByte-256.png \
		src/qt/res/icons/clock4.png \
		src/qt/res/icons/clock5.png \
		src/qt/res/icons/qrcode.png \
		src/qt/res/icons/ReddByte-16.png \
		src/qt/res/icons/ReddByte.png \
